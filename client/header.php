<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container">
    <a class="navbar-brand" href="./">
      <img src="./public\ask anything.jpg" width="90" height="45" class="d-inline-block align-top" alt="Centered Image"/>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <?php
        // Check if the 'user' key exists in the $_SESSION array and contains 'username'
